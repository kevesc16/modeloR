...
Numero_pasaporte    NUMBER (50)NOT NULL,
...
Curriculum_vitae    VARCHAR2(50)NOT NULL , 
...
CREATE TABLE Pagos ( 
id_pago         NUMBER (11),
pago_inicial    NUMBER (50)NOT NULL,
pago_mensual    NUMBER (50)NOT NULL,
Fecha_pago      DATE,
...
numero_cheque       NUMBER (50)     NOT NULL,
Cantidad_a_pagar    NUMBER (50)     NOT NULL,
Bancos_id           NUMBER (11)     NOT NULL
);

CREATE TABLE Beneficios(
id_beneficio            NUMBER (11)NOT NULL,
Cantidad_uso            NUMBER (50)NOT NULL,
Cantidad_maxima_uso     NUMBER(50),
...
Tipos_numeros_id    NUMBER (50) NOT NULL,
Clientes_id         NUMBER (11) NOT NULL
);
